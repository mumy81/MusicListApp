...
<ul class="nav nav-sidebar">
                ...
                <li><a href="${pageContext.request.contextPath}/create_album">Albüm Ekle</a></li>
...
<div class="col-sm-9 col-md-10 main">
    ...
    <div class="row">
		<form action="${pageContext.request.contextPath}/do_create_album" role="form" method="POST" class="col-md-9 go-right">
		...
		<div class="form-group">
		Sanatçı Adı: <br>
			<input id="artist" name="artist" type="tel" class="form-control" required>
			
		</div>
		<div class="form-group">
		Tarihi: <br>
			<textarea id="date" name="date" class="form-control" required></textarea>
